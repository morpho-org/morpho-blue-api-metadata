...
function filterTokens() {
  ...
  // Filter tokens for chainId 1, 8453, 137, 130, 10, 747474 & 42161 AND must have logoURI
  const filteredTokens = tokens.filter(
    (token) =>
      (token.chainId === 1 || token.chainId === 8453 || token.chainId === 137 || token.chainId === 130 || token.chainId === 10 || token.chainId === 747474 || token.chainId === 42161) && token.metadata?.logoURI
  );
