...
function filterTokens() {
  ...
  // Filter tokens for chainId 1, 8453, 10, 130, 137, 143, 988, 999, 747474, 42161, 98866 AND must have logoURI
  const filteredTokens = tokens.filter(
    (token) =>
      (token.chainId === 1 || token.chainId === 8453 || token.chainId === 10 || token.chainId === 130 || token.chainId === 137 || token.chainId === 143 || token.chainId === 988 || token.chainId === 999 || token.chainId === 747474 || token.chainId === 42161 || token.chainId === 98866) && token.metadata?.logoURI
  );
